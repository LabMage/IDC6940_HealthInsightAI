...
---
::: notes
Hello everyone, thank you for joining our presentation today. Our capstone project is focused on applying the k-Nearest Neighbors algorithm—or kNN—for disease diagnosis, specifically targeting diabetes prediction.
:::
...
## Implications for Healthcare Analytics {.smaller}
...
::: notes
In healthcare, recall matters more than accuracy — missing a diagnosis can delay treatment and cause harm.
Our project shows that kNN remains a relevant and interpretable tool, especially when combined with modern preprocessing techniques like SMOTE and scaling.
These methods can be extended beyond diabetes - to other diseases, patient risk scoring, or even real clinical systems.
With proper design, even simple algorithms like kNN can help improve early detection and support better care.
:::
